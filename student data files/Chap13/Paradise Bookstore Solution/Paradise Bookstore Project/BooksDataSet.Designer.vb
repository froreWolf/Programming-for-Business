...
Partial Public Class BooksDataSet
    ...
    Partial Public Class tblBooksDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddtblBooksRow(ByVal BookNumber As Integer, ByVal Title As String, ByVal Author As String, ByVal Price As Decimal, ByVal QuantityInStock As Integer) As tblBooksRow
            Dim rowtblBooksRow As tblBooksRow = CType(Me.NewRow,tblBooksRow)
            Dim columnValuesArray() As Object = New Object() {BookNumber, Title, Author, Price, QuantityInStock}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindByBookNumber(ByVal BookNumber As Integer) As tblBooksRow
            Return CType(Me.Rows.Find(New Object() {BookNumber}),tblBooksRow)
        End Function
    ...
    Partial Public Class tblBooksRow
        ...
        Public Property BookNumber() As Integer
            Get
                Return CType(Me(Me.tabletblBooks.BookNumberColumn),Integer)
            End Get
            Set
                Me(Me.tabletblBooks.BookNumberColumn) = value
            End Set
        End Property
        ...
        Public Property Price() As Decimal
            Get
                Try 
                    Return CType(Me(Me.tabletblBooks.PriceColumn),Decimal)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Price' in table 'tblBooks' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tabletblBooks.PriceColumn) = value
            End Set
        End Property
        ...
        Public Property QuantityInStock() As Integer
            Get
                Try 
                    Return CType(Me(Me.tabletblBooks.QuantityInStockColumn),Integer)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'QuantityInStock' in table 'tblBooks' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tabletblBooks.QuantityInStockColumn) = value
            End Set
        End Property
        ...
        Public Function IsPriceNull() As Boolean
            Return Me.IsNull(Me.tabletblBooks.PriceColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetPriceNull()
            Me(Me.tabletblBooks.PriceColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function IsQuantityInStockNull() As Boolean
            Return Me.IsNull(Me.tabletblBooks.QuantityInStockColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetQuantityInStockNull()
            Me(Me.tabletblBooks.QuantityInStockColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace BooksDataSetTableAdapters
    ...
    Partial Public Class tblBooksTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `tblBooks` WHERE ((`BookNumber` = ?) AND ((? = 1 AND `Title` IS NULL)"& _ 
                " OR (`Title` = ?)) AND ((? = 1 AND `Author` IS NULL) OR (`Author` = ?)) AND ((? "& _ 
                "= 1 AND `Price` IS NULL) OR (`Price` = ?)) AND ((? = 1 AND `QuantityInStock` IS "& _ 
                "NULL) OR (`QuantityInStock` = ?)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_BookNumber", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "BookNumber", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `tblBooks` (`BookNumber`, `Title`, `Author`, `Price`, `QuantityInStoc"& _ 
                "k`) VALUES (?, ?, ?, ?, ?)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("BookNumber", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "BookNumber", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `tblBooks` SET `BookNumber` = ?, `Title` = ?, `Author` = ?, `Price` = ?, `"& _ 
                "QuantityInStock` = ? WHERE ((`BookNumber` = ?) AND ((? = 1 AND `Title` IS NULL) "& _ 
                "OR (`Title` = ?)) AND ((? = 1 AND `Author` IS NULL) OR (`Author` = ?)) AND ((? ="& _ 
                " 1 AND `Price` IS NULL) OR (`Price` = ?)) AND ((? = 1 AND `QuantityInStock` IS N"& _ 
                "ULL) OR (`QuantityInStock` = ?)))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("BookNumber", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "BookNumber", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_BookNumber", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "BookNumber", Global.System.Data.DataRowVersion.Original, false, Nothing))
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Paradise_Bookstore_Project.My.MySettings.Default.BooksConnectionString
        End Sub
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As BooksDataSet.tblBooksDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As BooksDataSet.tblBooksDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As BooksDataSet.tblBooksDataTable = New BooksDataSet.tblBooksDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As BooksDataSet.tblBooksDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_BookNumber As Integer, ByVal Original_Title As String, ByVal Original_Author As String, ByVal Original_Price As Decimal, ByVal Original_QuantityInStock As Integer) As Integer
            ...
            Me.Adapter.DeleteCommand.Parameters(8).Value = CType(Original_QuantityInStock,Integer)
        ...
        Public Overloads Overridable Function Insert(ByVal BookNumber As Integer, ByVal Title As String, ByVal Author As String, ByVal Price As Decimal, ByVal QuantityInStock As Integer) As Integer
            ...
            Me.Adapter.InsertCommand.Parameters(4).Value = CType(QuantityInStock,Integer)
        ...
        Public Overloads Overridable Function Update(ByVal BookNumber As Integer, ByVal Title As String, ByVal Author As String, ByVal Price As Decimal, ByVal QuantityInStock As Integer, ByVal Original_BookNumber As Integer, ByVal Original_Title As String, ByVal Original_Author As String, ByVal Original_Price As Decimal, ByVal Original_QuantityInStock As Integer) As Integer
            ...
            Me.Adapter.UpdateCommand.Parameters(4).Value = CType(QuantityInStock,Integer)
            ...
            Me.Adapter.UpdateCommand.Parameters(13).Value = CType(Original_QuantityInStock,Integer)
        ...
        Public Overloads Overridable Function Update(ByVal Title As String, ByVal Author As String, ByVal Price As Decimal, ByVal QuantityInStock As Integer, ByVal Original_BookNumber As Integer, ByVal Original_Title As String, ByVal Original_Author As String, ByVal Original_Price As Decimal, ByVal Original_QuantityInStock As Integer) As Integer
            Return Me.Update(Original_BookNumber, Title, Author, Price, QuantityInStock, Original_BookNumber, Original_Title, Original_Author, Original_Price, Original_QuantityInStock)
        End Function
    End Class
