...
Public Class frmMain
    Private Sub TblEmployBindingNavigatorSaveItem_Click(sender As Object, e As EventArgs)
        Me.Validate()
        ...
        Try
            ...
            Me.TblEmployBindingSource.EndEdit()
            Me.TableAdapterManager.UpdateAll(Me.EmployeesDataSet)
            MessageBox.Show("Changes Saved", "Morgan Industries", MessageBoxButtons.OK, MessageBoxIcon.Information)
